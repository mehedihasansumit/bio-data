...
export const metadata: Metadata = {
  ...
  description:
    "তথ্য পূরণ করুন, সঙ্গে সঙ্গে প্রিভিউ দেখুন। চারটি ডিজাইন, বাংলা ও ইংরেজি দুই ভাষা, ছাপার উপযোগী A4 PDF — সম্পূর্ণ বিনামূল্যে।",
  alternates: {
    canonical: "/builder",
  },
  openGraph: {
    ...
    description:
      "তথ্য পূরণ করুন, প্রিভিউ দেখুন, A4 PDF ডাউনলোড করুন। চারটি ডিজাইন, দুই ভাষা, বিনামূল্যে।",
    url: "/builder",
    type: "website",
    locale: "bn_BD",
  },
