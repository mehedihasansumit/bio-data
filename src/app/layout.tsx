...
export const metadata: Metadata = {
  ...
  description:
    "বিয়ের বায়োডাটা অনলাইনে তৈরি করুন, সম্পূর্ণ বিনামূল্যে। তথ্য পূরণ করুন, ডিজাইন বেছে নিন, ছাপার উপযোগী A4 PDF ডাউনলোড করুন। বাংলা ও ইংরেজি — দুই ভাষাতেই।",
  ...
  openGraph: {
    ...
    description:
      "তথ্য পূরণ করুন, সঙ্গে সঙ্গে প্রিভিউ দেখুন, ছাপার উপযোগী A4 বায়োডাটা ডাউনলোড করুন। বাংলা ও ইংরেজি দুই ভাষাতেই।",
    url: "/",
    siteName: SITE_NAME,
    locale: "bn_BD",
    type: "website",
